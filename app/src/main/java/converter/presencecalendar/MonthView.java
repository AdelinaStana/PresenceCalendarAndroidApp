...
public class MonthView extends TableLayout{
    ...
    private int currentDaySelection = 32;
    ...
    private void init(Context contxt)
    {
        ...
        currentDaySelection = today.get(Calendar.DAY_OF_MONTH);
        DisplayMonth(true);
    }
...
//        db.close();
    ...
    public String getCurrentDate()
    {
        if(currentMonth<10)
        {
            String cm = "0"+currentMonth;
        }
        return currentDaySelection +"."+currentMonth+"."+currentYear;
    }
